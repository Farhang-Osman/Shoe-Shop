    ...
    <section className='max-container'>
      ...
      >
        <div className='flex flex-col items-start'>
          ...
          <p
            className='mt-6 text-base leading-7 font-montserrat sm:max-w-sm
            text-white-400'
          >
        ...
        <div className='flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap'>
          {footerLinks.map((section) => (
            <div key={section}>
              <h4
                className='text-2xl leading-normal font-medium text-white 
                font-montserrat'
              >
                {section.title}
              </h4>
              <ul className=''>
                {section.links.map((link) => (
                  <li
                    ...
                    text-white-400 hover:text-slate-gray cursor: pointer'
                  >
      ...
      <div
        ...
        max-sm:items-center text-white-400'
      >
        <div
